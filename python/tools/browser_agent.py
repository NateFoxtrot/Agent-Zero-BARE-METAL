...
from python.helpers.playwright import ensure_playwright_binary, get_playwright_binary, get_playwright_binary, get_playwright_binary
    ...
    async def _initialize(self):
        ...
        self.browser_session = browser_use.BrowserSession(
            browser_profile=browser_use.BrowserProfile(
                headless=False,  # CHANGED: Visible browser for Bare Metal
                ...
                # Standard desktop resolution for better visibility
                window_size={"width": 1280, "height": 900},
                screen={"width": 1920, "height": 1080},
                viewport={"width": 1280, "height": 900},
                no_viewport=False,
                # ARGS: Push window to 4th monitor (assuming 1920px width per screen * 3 = 5760 offset)
                args=[
                    "--window-position=5760,100", 
                    "--disable-infobars",
                    "--no-first-run",
        ...
        # --------------------------------------------------------------------------
        # Patch to enforce viewport size matches window
        # --------------------------------------------------------------------------
        if self.browser_session:
            try:
